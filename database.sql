...
--  2. 	1.	How do you get all users with usernames that contain the letter a?
...
--7. How do you get all users with account balances that are more than $100?
	SELECT "username" FROM "account_balance" WHERE "account_balance" >100;
	
--8. How do you add a new account?

INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('name', 'city', '', '', '');
...
--9. The bank is losing money in Miami and Phoenix and needs to unload low transaction customers: How do you delete users that reside in miami OR phoenix and have completed fewer than 5 transactions. 
	SELECT "username" FROM "accounts" WHERE ("city" = 'phoenix' OR "city" = 'miami') AND "transactions_completed" < 5;
